...
<div id="center" style="margin-top:20px;">
		<button style="margin: 0 20px;" type="button" onclick="listAll()" class="listBtn">전체
			문의 내역</button>
		<button style="margin: 0 20px;" type="button" onclick="checking()" class="listBtn">처리
			중인 문의 내역</button>
		<button style="margin: 0 20px;"type="button" onclick="complete()" class="listBtn">답변
			완료한 문의 내역</button>
</div>
<!-- 
<button type="button"
