...
<div style="margin-top:50px;">
   <button id="itemInput" style="width:150px; height:45px;" type="button"><a href="/item/register">상품 등록</a>
</button>
</div>
</div>
</div>
            ...
            <div class="itemImage">
               <c:choose>
                  <c:when test="${item.imageList.size()!=0}">
                     <a class="move" href="${item.itemNumber}">
                     <img src="${item.imageList.get(0).viewLoadName}"
...
<form name="searchForm" id="searchForm" action="/item/getList"
   method="get">
   <select id="type" name="type">
      ...
      <option value="NC" ${pageDTO.pi.type eq 'NC'?"selected":""}>제목or내용</option>
...
<form id="itemForm" action="/item/getList" method="get">
      ...
      $(document).ready(function(){
         ...
         var itemForm = $('#itemForm');
           ...
           $(".move").on("click", function(e){
            ...
            /*   itemForm.append("<input type='hidden' name='itemNumber' value='"+itemNumber+"'>"); */
